...
def gerar_analise(dados, segmento, modelo=None):
    ...
    prompt = (
                ...
                f"  EXEMPLO DE AÇÃO CORRETA: 'Revisar o preço dos produtos de maior venda para verificar "
                f"competitividade e margem.'\n"
                ...
                f"quantidade disponível' · 'revisar o preço dos produtos de maior venda para verificar competitividade "
                f"e margem' · 'responder o WhatsApp até as 20h no sábado'.\n"
